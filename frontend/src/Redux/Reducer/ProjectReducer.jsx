import { ADD_REVIEW_FAIL, ADD_REVIEW_REQUEST, ADD_REVIEW_SUCCESS, ALL_PROJECT_FAIL, ALL_PROJECT_REQUEST, ALL_PROJECT_SUCCESS, BUY_PROJECT_FAIL, BUY_PROJECT_REQUEST, BUY_PROJECT_RESET, BUY_PROJECT_SUCCESS, DELETE_PROJECT_USER_FAIL, DELETE_PROJECT_USER_REQUEST, DELETE_PROJECT_USER_RESET, DELETE_PROJECT_USER_SUCCESS, EDITED_PROJECT_REQUEST, EDIT_DETAILS_SUCCESS, EDIT_PROJECT_FAIL, EDIT_PROJECT_REQUEST, EDIT_PROJECT_RESET, EDIT_PROJECT_SUCCESS, GET_ALL_REVIEWS_FAIL, GET_ALL_REVIEWS_REQUEST, GET_ALL_REVIEWS_SUCCESS, GET_USER_ALL_PROJECT_AFTER_DELETION, GET_USER_ALL_PROJECT_REQUEST, GET_USER_ALL_PROJECT_SUCCESS, PROJECT_DETAILS_FAIL, PROJECT_DETAILS_REQUEST, PROJECT_DETAILS_SUCCESS, SELL_PROJECT_FAIL, SELL_PROJECT_REQUEST, SELL_PROJECT_RESET, SELL_PROJECT_SUCCESS } from "../ActionType"
...
export const deleteProjectUserReducer = (state={
    ...
    switch(type){
        ...
        case DELETE_PROJECT_USER_RESET:
            return{
                ...state,
                loading :false,
                error:"",
